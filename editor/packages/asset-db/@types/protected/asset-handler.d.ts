...
export interface CustomHandler extends CustomHandlerBase {
    ...
    // 指定资源的缩略图信息，可以同时指定 icon 和 image ，如果需要从 thumbnail 处获取数据，也可以填写值为 'thumbnail'
    iconInfo?: {
        default: ThumbnailInfo;
        /**
         * 获取某个资源的缩略图信息（缩略图地址，icon 图标等）
         ...
         * @param asset 
         */
        generateThumbnail?(asset: IAsset, options?: QueryThumbnailOptions): ThumbnailInfo | Promise<ThumbnailInfo>;
    };
